  ...
  $.widget(
    ...
    $.extend({}, $.ui.sortable.prototype, {
        ...
        for (i = this.items.length - 1; i >= 0; i--) {
          ...
          if (itemElement.className.indexOf(o.disabledClass) !== -1) {
            ...
            if (intersection === 2) {
              ...
              if (
                itemAfter &&
                itemAfter.item[0].className.indexOf(o.disabledClass) !== -1
              ) {
                continue;
              }
              ...
              if (
                itemBefore &&
                itemBefore.item[0].className.indexOf(o.disabledClass) !== -1
              ) {
                continue;
              }
            }
      ...
      _mouseStop: function (event, noPropagation) {
        ...
        var sort = this.domPosition.prev
          ? $(this.domPosition.prev).next().index()
          : 0;

        if (
          !(
            pid == this._uiHash().item.parent().parent().attr("id") &&
